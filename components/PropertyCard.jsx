    ...
    return (
        <div className="rounded-xl shadow-md relative">
            ...
            <div className="p-4">
                ...
                >
                    <p><FaMoneyBill className="md:hidden lg:inline" /> <span className="text-black">Weekly</span> ${property.rates.weekly}</p>
                    <p><FaMoneyBill className="md:hidden lg:inline" /> <span className="text-black">Monthly</span> ${property.rates.monthly}</p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between mb-4">
                    <div className="flex align-middle gap-2 mb-4 lg:mb-0">
                        <FaMapMarker className="text-orange-700 md:hidden lg:inline" />
